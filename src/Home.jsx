...
function Home(){
  ...
  const handleButtonQuoteGenerator = () => {
    setClicked(true);
    setTimeout(() => 
      navigate("/quotegenerator"),400
    );
  };
  const handleButtonEcommerce = () => {
    setClicked(true);
    setTimeout(() => 
      navigate("/ecommerce"),400
    );
  };
  const handleButtonSocialMedia = () => {
    setClicked(true);
    setTimeout(() => 
      navigate("/socialmedia"),400
    );
  };
  ...
  return(
    ...
    className="main" id="page">
      <div className="container1">
        <motion.div
        initial={{x:-100, opacity:0}}
        animate={{x:[-100,10,0],opacity:1}}
        transition={{duration:0.6, ease:"easeIn"}}>
        <h1>Shibin</h1></motion.div>
        <motion.div
        initial={{opacity:0}}
        animate={{opacity:1}}
        transition={{duration:0.7,ease:"easeIn",delay:0.8}}>
        <p>I’m a full-stack developer who wants to help<br></br>make the internet a more creative, accessible,<br></br> and better place.</p></motion.div>
        <div className="hello">
          <motion.div
          ...
          <a href="https://www.linkedin.com/in/shibin-shibi-31271824a/" target="_blank" rel="noopener noreferrer" className="linkedin-icon"><FaLinkedin size={29} />
          ...
          whileHover={{scale:1.2}}
          transition={{duration:0.3,ease:"easeOut"}}>
          <a href="https://mail.google.com/mail/?view=cm&to=shibi393493@gmail.com" target="_blank" rel="noopener noreferrer" className="mail-icon"><AiOutlineMail size={29}/></a></motion.div></motion.div>
          <motion.div
          initial={{y:50,opacity:0}}
          animate={{y:[50,-8,3,0],opacity:1}}
...
>
          ...
          {showText && <div className="text-overlay">Quiz Website</div>}</motion.div></motion.div>
          <motion.div
       ...
       transition={{duration:1.1,ease:"easeInOut",delay:1.3}}>
          ...
          {showText2 && <div className="text-overlay">E-commerece website</div>}</motion.div></motion.div>
          ...
          {showText3 && <div className="text-overlay">Developer Community Social Media</div>}</motion.div></motion.div>
       ...
       transition={{duration:1.5,ease:"easeInOut",delay:1.3}}>
          ...
          {showText4 && <div className="text-overlay">Random Quote Generator</div>}</motion.div></motion.div>
        </motion.div>
      </div>
      ...
      transition={{duration:0.3,ease:"easeInOut"}}>
        ...
        <motion.h2
        className="h2">Education & Qualification</motion.h2>

        <motion.div className="textbox">
          <ul>
            <li><b>Bachelor of Computer Application (BCA) - </b>Calicut University <i>(2021-2024)</i></li>
            <li><b>Higher Secondary Education (Computer Science) - </b>MSM Higher Secondary School <i>(2019-2021)</i></li>
